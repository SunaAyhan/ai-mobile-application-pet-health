...
class _State extends State<Mesaj> {
  ...
  List<ChatMessage> messages = [
    ChatMessage(mesajIcerik: "Merhaba doktor bey", mesajTuru: "gonderen"),
    ChatMessage(
        mesajIcerik: "Merhaba, nasıl yardımcı olabilirim?", mesajTuru: "alan"),
    ChatMessage(
        mesajIcerik: "Kedimde sivilceler var. Yardımcı olabilir misiniz?",
        mesajTuru: "gonderen"),
    ChatMessage(
        mesajIcerik: "Tabi. Görüntülü ararsan yardımcı olabilirim.",
        mesajTuru: "alan"),
    ChatMessage(mesajIcerik: "Hemen Arıyorum", mesajTuru: "gonderen"),
  ];
  @override
